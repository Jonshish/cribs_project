...
def contact(request):
    ...
    # Send email
    # Send email
    # send_mail('Apartment Inquiry', 'There has been an inquiry for ' + rental + '. Sign into the admin panel for more info', 'info@cribsnyc.com', [realtor_email,], fail_silently=False) 
